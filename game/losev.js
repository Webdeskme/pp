...
*/
    ...
    this.tweens.add({
      ...
      function shuffle(array) {
        ...
        if(localStorage.getItem(localStoragePlayer) == null) {
            player = 1;
        } else {
            player = localStorage.getItem(localStoragePlayer);
        }
        var playerText = this.add.bitmapText(700, 225, 'topaz', 'Player: ' + player, 64).setScrollFactor(0,0);
