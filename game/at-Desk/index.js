var SceneC = new Phaser.Class({
    ...
    create: function ()
    {
      ...
      function shuffle(array) {
        ...
        var s1 = this.add.image(850, 75, score[0]).setInteractive();
        s1.setScale(1/8);
        var s11 = 'yes';
        var s2 = this.add.image(850, 225, score[1]).setInteractive();
        s2.setScale(1/8);
        var s22 = 'yes';
        var s3 = this.add.image(850, 375, score[2]).setInteractive();
        s3.setScale(1/8);
        var s33 = 'yes';
        var s4 = this.add.image(950, 75, score[3]).setInteractive();
        s4.setScale(1/8);
        var s44 = 'yes';
        var s5 = this.add.image(950, 225, score[4]).setInteractive();
        s5.setScale(1/8);
        var s55 = 'yes';
        var s6 = this.add.image(950, 375, score[5]).setInteractive();
        s6.setScale(1/8);
        var s66 = 'yes';
        ...
        function g2(th){
          ...
          loseText.setText('Losses:' + lose);
          //var cx = c21;
           c21 = th.add.image(50, 575, cards[20]).setInteractive();
          playc(th, c21, cx, cards[20]);
           c22 = th.add.image(150, 575, cards[21]).setInteractive();
          playc(th, c22, cx, cards[21]);
           c23 = th.add.image(250, 575, cards[22]).setInteractive();
          playc(th, c23, cx, cards[22]);
           c24 = th.add.image(350, 575, cards[23]).setInteractive();
          playc(th, c24, cx, cards[23]);
           c25 = th.add.image(450, 575, cards[24]).setInteractive();
          playc(th, c25, cx, cards[24]);
           c26 = th.add.image(550, 575, cards[25]).setInteractive();
          playc(th, c26, cx, cards[25]);
           c27 = th.add.image(650, 575, cards[26]).setInteractive();
          playc(th, c27, cx, cards[26]);
           c28 = th.add.image(750, 575, cards[27]).setInteractive();
          playc(th, c28, cx, cards[27]);
           c29 = th.add.image(850, 575, cards[28]).setInteractive();
          playc(th, c29, cx, cards[28]);
           c30 = th.add.image(950, 575, cards[29]).setInteractive();
